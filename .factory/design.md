...
- `site/public/paper-courier-contact-sheet.png` is an original output of the bundled `shot-runner demo` pipeline on 2026-08-29. It is included as factual first-viewport demo evidence, not decorative art; no external asset or model was used.
