...
The browser page stores only `demo:animation-shot-runner:opened`. The persistent banner says “Demo — sample data, nothing is saved” and provides **Reset demo** and **Start for real**. Reset recreates only that demo key. Start for real returns to `/`.
