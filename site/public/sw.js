const CACHE='shot-runner-v1';
const SHELL=['/','/index.html','/privacy/','/terms/','/favicon.svg','/shot-proof.webp','/shot-proof-768.webp','/fonts/instrument-serif.woff2','/fonts/ibm-plex-mono.woff2'];
